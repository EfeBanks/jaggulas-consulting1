    ...
    <div className='FooterBg p-5 border-top border-secondary'>
      <div className="container">
        <div className="row py-3 d-flex justify-content-center g-4 text-center">
          ...
          <div className=" col-sm-6 col-md-2 px-1">
          <h5 className='about-heading'>Quick Links</h5>
            <p> <Link to="/" className='link-text small text-center'>Home</Link> </p>
            <p> <Link to="/Services" className='link-text small text-center'>Services</Link> </p>
            <p> <Link to="/About" className='link-text small text-center'>Who We Are</Link> </p>
            <p> <Link to="/Careers" className='link-text small text-center'>Careers</Link> </p>
            <p> <Link to="/Contact" className='link-text small text-center'>Contact</Link> </p>
          </div>
          <div className="col-sm-6 col-md-4 px-1">
            ...
            <h5 className='about-heading'>Services</h5>
              ...
              <p> <HashLink to='/Services#professional' className='link-text small'>Migration & Modernization</HashLink> </p>
